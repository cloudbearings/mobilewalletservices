...
import com.mobilewallet.users.bo.NotificationsBO;
 ...
 */
@Path("notifications")
public class NotificatonsService {

    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public Object pushNotification(@QueryParam("userId") String eid, @QueryParam("status") String status, @QueryParam("type") String type) {
        ...
        if (userId != null) {
            ...
            try {
                ...
                if (user != null) {
                    int updated = NotificationsBO.updateNotification(user.getUserId(), status, type);
                    obj.put("sc", "Y");
                    return obj.toString();
                } else {
