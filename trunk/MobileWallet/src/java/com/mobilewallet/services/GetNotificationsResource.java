...
public class GetNotificationsResource {

    private final Log log = LogFactory.getLog(GetNotificationsResource.class);

    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public Object getNotificationStatus(@QueryParam("id") String eid) {
        ...
        if (userId != null) {
            ...
            if (user != null) {
                return PushNotificationsBO.getNotificationStatusOfUser(user.getUserId());
            }
        }
